...
import { Search, Bell, MessageSquare, Calendar, Package, LogOut } from "lucide-react";
...
const PatientOrders = () => {
  ...
  const navItems = [
    ...
    { icon: Package, label: "Orders", path: "/patient-dashboard/orders", active: true },
  ];
          ...
          <CardContent className="p-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div>
                ...
                <p className="opacity-90 mt-1">Track and manage your medication orders</p>
              </div>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="text-center py-10">
              ...
              <p className="text-gray-500 mb-6">You haven't placed any medication orders yet.</p>
