...
import { Search, Bell, MessageSquare, Calendar, Package, LogOut, ShoppingCart, Filter, Star } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-white">
      ...
      <main className="container mx-auto px-4 py-6">
        ...
        <Card className="mb-6 bg-gradient-to-r from-green-500/90 to-teal-600/90 text-white border-none shadow-md">
          <CardContent className="p-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div>
                <h1 className="text-2xl font-bold font-playfair">Online Pharmacy</h1>
                <p className="opacity-90 mt-1">Browse and order medications from trusted pharmacies</p>
              </div>
              <div className="flex flex-wrap gap-2">
                ...
                <Button variant="secondary" size="sm" className="bg-white text-green-600 border-none relative">
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 mb-6 flex flex-wrap gap-2 items-center">
          ...
          <Button size="sm" variant="outline" className="rounded-full text-xs">All</Button>
          <Button size="sm" variant="outline" className="rounded-full text-xs">Pain Relief</Button>
          <Button size="sm" variant="outline" className="rounded-full text-xs">Antibiotics</Button>
          <Button size="sm" variant="outline" className="rounded-full text-xs">Diabetes</Button>
          <Button size="sm" variant="outline" className="rounded-full text-xs">Allergy Relief</Button>
        </div>

        {/* Medicines Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
          {filteredMedicines.map((medicine) => (
            <Link to={`/patient-dashboard/medicines/${medicine.id}`} key={medicine.id}>
              <Card className="h-full hover:shadow-md transition-all duration-300 hover:-translate-y-1 overflow-hidden">
                ...
                <CardContent className="p-4">
                  ...
                  <div className="text-xl font-bold text-green-600 mb-2">KSh {medicine.price}</div>
                  <div className="flex items-center gap-2 mt-3">
                    ...
                    <span className="text-sm text-gray-600">{medicine.pharmacy}</span>
      ...
      <footer className="bg-gray-900 text-white py-12 mt-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Medicine Delivery</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Home Nursing</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Ambulance Services</a></li>
              </ul>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} Afya Mawinguni. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
