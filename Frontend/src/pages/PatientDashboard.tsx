...
import { Search, Bell, MessageSquare, Calendar, Package, ShoppingBag, FileText, LogOut } from "lucide-react";
          ...
          <CardContent className="p-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div>
                ...
                <p className="opacity-90 mt-1">Here's your health dashboard overview</p>
              </div>
