            ...
            <div className="grid grid-cols-1 gap-6">
              <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Create subscription plans for your patients to get discounted services
                    </p>
                  </div>
                  <Button 
                ...
                <CardContent>
                  {showSubscriptionForm && (
                    <div className="mb-8 bg-gray-50 p-4 rounded-lg border">
                      <h3 className="font-medium mb-4">Create New Subscription Plan</h3>
                      <Form {...subscriptionForm}>
                        <form onSubmit={subscriptionForm.handleSubmit(onAddSubscriptionPlan)} className="space-y-4">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <FormControl>
                                    <Input placeholder="e.g., Basic Care Plan" {...field} />
                                  </FormControl>
                                </FormItem>
                              )}
                            />
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Textarea 
                                    placeholder="e.g., 10% discount on all consultations
Free medication delivery
Priority booking" 
                                    className="h-32"
                                    {...field}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {subscriptionPlans.map((plan) => (
                      <Card key={plan.id} className={`border-2 ${plan.isActive ? 'border-green-500/20' : 'border-gray-200'}`}>
                        <CardHeader>
                          <div className="flex justify-between items-center">
                        ...
                        <CardContent>
                          ...
                          <ul className="space-y-2">
                            {plan.features.map((feature, index) => (
                              <li key={index} className="flex items-start gap-2">
                                <span className="bg-green-100 text-green-600 rounded-full p-1 flex items-center justify-center mt-0.5">
                          ...
                          <div className="flex justify-between mt-6">
                            <Button 
                              ...
                              size="sm"
                              className="text-xs"
                              onClick={() => toggleSubscriptionStatus(plan.id)}
                            >
                  ...
                  {subscriptionPlans.length === 0 && (
                    <div className="text-center py-8 text-gray-500">
                      No subscription plans added yet. Click the button above to add a new plan.
                    </div>
                  )}
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  <h2 className="text-xl font-semibold">Subscription Benefits Configuration</h2>
                </CardHeader>
                <CardContent>
                  <div className="space-y-6">
                    <div className="border rounded-lg p-4">
                      <h3 className="font-medium mb-3">Consultation Discounts</h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <p className="text-sm text-gray-600">Basic Plan Discount (%)</p>
                          <Input type="number" defaultValue="10" className="max-w-[120px]" />
                        </div>
                        <div className="space-y-2">
                          <p className="text-sm text-gray-600">Premium Plan Discount (%)</p>
                          <Input type="number" defaultValue="25" className="max-w-[120px]" />
                        </div>
                      </div>
                    </div>
                    
                    <div className="border rounded-lg p-4">
                      <h3 className="font-medium mb-3">Priority Services</h3>
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="font-medium">Priority Appointments</p>
                            <p className="text-sm text-gray-600">Subscribers get priority booking slots</p>
                          </div>
                          <Switch defaultChecked />
                        </div>
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="font-medium">Extended Consultations</p>
                            <p className="text-sm text-gray-600">Longer consultation times for subscribers</p>
                          </div>
                          <Switch defaultChecked />
                        </div>
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="font-medium">Free Follow-ups</p>
                            <p className="text-sm text-gray-600">Free follow-up consultations within 2 weeks</p>
                          </div>
                          <Switch />
                        </div>
                      </div>
