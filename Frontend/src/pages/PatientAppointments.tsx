...
const PatientAppointments = () => {
  ...
  const navItems = [
    { icon: Calendar, label: "Appointments", path: "/patient-dashboard/appointments", active: true },
          ...
          <CardContent className="p-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div>
                ...
                <p className="opacity-90 mt-1">Manage your upcoming and past appointments</p>
              </div>
