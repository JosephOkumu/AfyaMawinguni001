...
const commonMedicineImg = "/lovable-uploads/a05b3053-380f-4711-b032-bc48d1c082f0.png";
...
const medicineData: MedicineType[] = [
  { 
    ...
    dosageAdult: "1-2 tablets every 4-6 hours as needed, not exceeding 8 tablets in 24 hours.",
    dosageChildren: "For children 6-12 years: 1/2 to 1 tablet every 4-6 hours as needed, not exceeding 4 tablets in 24 hours. Not recommended for children under 6 without medical advice.",
  ...
  { 
    ...
    status: "In Stock",
    description: "Amoxicillin is an antibiotic used to treat a number of bacterial infections. These include middle ear infection, strep throat, pneumonia, skin infections, and urinary tract infections.",
    dosageAdult: "250mg to 500mg every 8 hours or 500mg to 875mg every 12 hours, depending on the type and severity of infection.",
    dosageChildren: "20 to 40mg/kg/day divided into 3 doses every 8 hours or 2 doses every 12 hours, depending on weight and severity of infection.",
  ...
  { 
    ...
    category: "Pain Relief",
    status: "Low Stock",
    description: "Ibuprofen is a nonsteroidal anti-inflammatory drug (NSAID) used to relieve pain, reduce inflammation, and lower fever. It works by blocking the production of certain natural substances that cause inflammation.",
    dosageAdult: "400mg to 800mg every 6 to 8 hours as needed, not exceeding 3,200mg per day.",
    dosageChildren: "5 to 10mg/kg every 6 to 8 hours. Children's dosage should be determined by a doctor based on weight.",
  ...
  { 
    ...
    status: "In Stock",
    description: "Loratadine is an antihistamine that reduces the effects of natural chemical histamine in the body. Histamine can produce symptoms of sneezing, itching, watery eyes, and runny nose. It is used to treat the symptoms of allergies.",
    dosageAdult: "10mg once daily.",
    dosageChildren: "For children 6 years and older: 10mg once daily. For children 2-5 years: 5mg once daily.",
  ...
  { 
    ...
    category: "Diabetes",
    status: "In Stock",
    description: "Metformin is used to treat type 2 diabetes. It is used along with diet and exercise to help control blood sugar levels. It works by decreasing the amount of sugar your liver makes and helping your body use insulin more effectively.",
    dosageAdult: "Start with 500mg twice daily with meals. May increase to 2,000mg per day based on response.",
    dosageChildren: "Not typically prescribed for children under 10 years. For children 10-16 years, dosage should be determined by a doctor.",
  ...
  { 
    ...
    status: "In Stock",
    description: "Omeprazole is a proton pump inhibitor that decreases the amount of acid produced in the stomach. It is used to treat symptoms of gastroesophageal reflux disease (GERD) and other conditions involving excessive stomach acid such as Zollinger-Ellison syndrome.",
    dosageAdult: "20mg once daily for 4-8 weeks.",
    dosageChildren: "For children 1-16 years: Weight-based dosing determined by a doctor, typically 10-20mg once daily.",
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="md:col-span-1 bg-white overflow-hidden">
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between mb-2">
                <Badge variant={
                  medicine?.status === "In Stock" ? "outline" : 
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-sm ml-1 font-medium">{medicine?.rating}</span>
                </div>
              </div>
              <div className="flex items-center gap-2 mt-3">
                <Avatar className="h-8 w-8">
                  {medicine?.pharmacyLogo ? (
                    <AvatarImage src={medicine.pharmacyLogo} alt={medicine.pharmacy} />
                  ) : null}
                ...
                <div>
                  <span className="text-sm font-medium">{medicine?.pharmacy}</span>
          ...
          <Card className="md:col-span-1 bg-white">
            <CardContent className="p-6">
              <h1 className="text-2xl font-bold mb-2 font-playfair">{medicine?.name}</h1>
              <div className="text-sm text-gray-500 mb-4">Category: {medicine?.category}</div>
              <div className="text-2xl font-bold text-green-600 mb-6">KSh {medicine?.price}</div>
              ...
              <Tabs defaultValue="dosage">
                ...
                <TabsContent value="dosage" className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700">{medicine?.dosageChildren}</p>
                  </div>
                </TabsContent>
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <Card className="w-full max-w-md mx-auto shadow-xl overflow-hidden border-none">
            <div className="bg-gradient-to-r from-primary-blue to-secondary-green text-white p-5">
              ...
              <p className="text-sm opacity-90">Complete your purchase securely</p>
            </div>
            <CardContent className="p-6">
              <div className="border-b pb-4 mb-4">
                ...
                <div className="flex justify-between mb-2">
                  ...
                  <span>KSh {medicine?.price} x {quantity}</span>
                </div>
                <div className="flex justify-between font-bold mt-4 text-lg">
                  <span>Total</span>
                  <span className="text-green-600">KSh {medicine?.price ? medicine.price * quantity : 0}</span>
                </div>
              </div>
              ...
              <RadioGroup value={paymentMethod} onValueChange={setPaymentMethod} className="space-y-3 mb-4">
                ...
                <div className={`border rounded-lg transition-all ${paymentMethod === "mpesa" ? "border-green-500 bg-green-50" : "border-gray-200"}`}>
                  <div className="flex items-center p-4">
                    <RadioGroupItem value="mpesa" id="mpesa" className="mr-3" />
                    <Label htmlFor="mpesa" className="flex flex-1 items-center gap-3 cursor-pointer">
                      <div className="w-10 h-10 rounded-full bg-green-500 flex items-center justify-center text-white font-bold">
                        M
                      </div>
                      <div>
                        <span className="font-medium">M-PESA</span>
                        <p className="text-xs text-gray-600">Fast and secure mobile payment</p>
                      </div>
                    </Label>
                  </div>
                  {paymentMethod === "mpesa" && (
                    <div className="px-4 pb-4 pt-0">
                      <p className="text-sm text-gray-600 mb-3">Enter your phone number to receive payment prompt</p>
                      <Input 
                        type="tel" 
                ...
                {/* Credit Card Option */}
                <div className={`border rounded-lg transition-all ${paymentMethod === "card" ? "border-blue-500 bg-blue-50" : "border-gray-200"}`}>
                  <div className="flex items-center p-4">
                    ...
                    <Label htmlFor="card" className="flex flex-1 items-center gap-3 cursor-pointer">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-600">Pay with Visa, Mastercard, or American Express</p>
                      </div>
                    </Label>
                  </div>
                  {paymentMethod === "card" && (
                ...
                {/* PayPal Option */}
                <div className={`border rounded-lg transition-all ${paymentMethod === "paypal" ? "border-blue-600 bg-blue-50" : "border-gray-200"}`}>
                  <div className="flex items-center p-4">
                    ...
                    <Label htmlFor="paypal" className="flex flex-1 items-center gap-3 cursor-pointer">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-600">Fast, secure online payment</p>
                      </div>
                    </Label>
                  </div>
                  {paymentMethod === "paypal" && (
                    <div className="px-4 pb-4 pt-0">
                      <p className="text-sm text-gray-600 mb-3">You will be redirected to PayPal to complete your payment securely.</p>
                    </div>
                  )}
                </div>
              </RadioGroup>
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <Card className="w-full max-w-md mx-auto shadow-xl overflow-hidden border-none">
            <CardContent className="p-8 text-center">
              ...
              <h2 className="text-2xl font-bold mb-2 font-playfair">Payment Successful!</h2>
              <p className="text-gray-600 mb-6">Your order has been placed successfully.</p>
              
              <div className="bg-gray-50 p-5 rounded-lg mb-6 text-left">
                <div className="flex justify-between mb-2">
                  <span className="text-gray-500">Order ID</span>
                  <span className="font-medium">AM{Math.floor(10000 + Math.random() * 90000)}</span>
                </div>
                <div className="flex justify-between mb-2">
                  <span className="text-gray-500">Amount Paid</span>
                  <span className="font-medium text-green-600">KSh {medicine?.price ? medicine.price * quantity : 0}</span>
                </div>
      ...
      <footer className="bg-gray-900 text-white py-12 mt-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4 font-playfair">Afya Mawinguni</h3>
              <p className="text-gray-400 mb-4">Transforming healthcare access and delivery across Africa through innovative digital solutions.</p>
