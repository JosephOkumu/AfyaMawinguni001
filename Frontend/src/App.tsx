      ...
      <BrowserRouter>
        <div className="flex flex-col min-h-screen">
          <Routes>
            ...
            {/* Medicine Routes */}
            <Route path="/patient-dashboard/medicines" element={<PatientMedicines />} />
            <Route path="/patient-dashboard/medicines/:id" element={<MedicineDetails />} />
            
            {/* Lab Test Routes */}
            <Route path="/patient-dashboard/lab-tests" element={<PatientLabTests />} />
            <Route path="/patient-dashboard/lab-provider/:id" element={<LabProviderDetails />} />
            
            {/* Doctor Consultation Routes */}
            <Route path="/patient-dashboard/consultation" element={<DoctorConsultation />} />
            <Route path="/patient-dashboard/doctor/:id" element={<DoctorDetails />} />
            
            {/* Home Nursing Routes */}
            <Route path="/patient-dashboard/nursing" element={<HomeNursingProviders />} />
            <Route path="/patient-dashboard/nursing/:id" element={<HomeNursingDetails />} />
            
            {/* Provider Dashboard Routes */}
            <Route path="/provider/home-nursing" element={<HomeNursingDashboard />} />
