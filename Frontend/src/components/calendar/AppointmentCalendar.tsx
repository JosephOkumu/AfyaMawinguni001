                    ...
                    {selectedAppointment.type === "virtual" ? (
                      ...
                      <>
                        <Button
                          ...
                          onClick={() => {
                            console.log("🎥 [AppointmentCalendar] Video Call button clicked, opening full-page interface for appointment:", selectedAppointment?.id);
                            setShowAppointmentDetails(false);
                            // Open full-page video call interface
