      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <section className="mb-12 text-center bg-gradient-to-r from-primary-blue to-secondary-green text-custom-white p-8 rounded-lg shadow-md">
          ...
          <p className="leading-relaxed">
            Aceso Health Solutions is an all-in-one digital platform that brings hospital services directly to your home. Whether you're booking an online specialist, ordering prescription medicine, scheduling a home nurse visit, or requesting lab sample collection—Aceso Health Solutions makes it fast, easy, and accessible.
          </p>
        </section>

        {/* Story Section */}
        <section className="mb-12">
          <h2 className="text-3xl font-semibold mb-4 text-secondary-green">Bringing Healthcare Home – The Aceso Health Solutions Story</h2>
          <p className="text-custom-dark leading-relaxed">
            At Aceso Health Solutions, we believe that access to quality healthcare should be simple, affordable, and within reach of everyone—no matter where they are. Our name, Aceso, comes from the Greek goddess of healing and recovery, reflecting our mission: to make hospital-grade care accessible online, through a seamless and trustworthy platform.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-custom-dark leading-relaxed mb-4">
            Aceso Health Solutions empowers doctors, nurses, and lab technicians by connecting them directly with patients who need their expertise.
          </p>
