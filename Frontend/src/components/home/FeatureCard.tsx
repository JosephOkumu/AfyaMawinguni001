    ...
    <Card className="group relative h-full bg-white/70 backdrop-blur-sm border-0 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden">
      ...
      <CardContent className="relative p-8 h-full flex flex-col">
        ...
        <div className="relative mb-6">
          <div className="w-16 h-16 bg-gradient-to-br from-blue-100 to-green-100 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
            ...
            <Icon className="h-8 w-8 text-primary-blue group-hover:text-white transition-colors duration-300 relative z-10" />
          </div>
