...
import { UserCog, Calendar, UserRound, Video, Pill, Beaker } from "lucide-react";

const FeaturesSection = () => {
  return (
    <div className="py-16 bg-custom-light-gray">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl md:text-3xl font-bold text-center text-primary-blue mb-2">Our Services</h2>
        <p className="text-center mb-12">Comprehensive healthcare solutions for patients and providers</p>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <FeatureCard 
            title="AI Health Assistant"
            description="Our intelligent AI assistant helps you find the right healthcare professional based on your symptoms and preferences, offering personalized recommendations and quick access to medical advice."
            icon={UserCog}
          />
