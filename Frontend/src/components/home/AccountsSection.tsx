      ...
      <div className="relative container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex items-center justify-center mt-8 mb-4">
            <div className="h-px bg-gradient-to-r from-transparent via-blue-300 to-transparent w-32 flex-shrink-0"></div>
            <div className="mx-4 w-2 h-2 bg-blue-400 rounded-full flex-shrink-0"></div>
            <div className="h-px bg-gradient-to-r from-transparent via-green-300 to-transparent w-32 flex-shrink-0"></div>
          </div>
        </div>
